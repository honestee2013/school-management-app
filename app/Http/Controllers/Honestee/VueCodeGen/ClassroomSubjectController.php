...
use App\Models\Honestee\VueCodeGen\ClassroomSubject;
...
class ClassroomSubjectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request['id'] == "all"){
            $result = ClassroomSubject::all();
            return $this->sendResponse($result, 'classroom_subject list ');

        }else if($request['id']){
            $result = ClassroomSubject::findOrFail($request['id']);
            return $this->sendResponse($result, 'classroom_subject ');
        }
        ...
        if($sortField)
            $classroom_subject = $query->orderBy($sortField, $sortType)->paginate( $perPage );
        else       
            $classroom_subject = $query->paginate( $perPage );
  
        return $this->sendResponse($classroom_subject, 'classroom_subject list ');
    }
    ...
    public function search($request, $query)
    {
        ...
        $fields = Schema::getColumnListing('$classroom_subject');
    ...
    public function store(Request $request)
    {
        ...
        if($model_id && $relation &&  $pv_ids){ // Many to Many relationships
            ...
            $classroomsubject = ClassroomSubject::create($request->all());    
            return $this->sendResponse( $classroomsubject, 'ClassroomSubject Created Successfully');
        }
    ...
    public function checkValidation(Request $request){
        $data = DB::select('DESCRIBE '.strtolower( 'classroom_subject' ));
    ...
    public function update(Request $request, $id)
    {
        ...
        $input = $request->all();
        $classroomsubject->fill($input)->save();
        return $this->sendResponse($classroomsubject, 'ClassroomSubject Information has been updated');
    }
    ...
    public function destroy($parameters)
    {
        ...
        if (array_key_exists('tbl', $data) && array_key_exists('pv_tbl', $data) 
           ...
           { // Many to Many relationships
            ...
            ClassroomSubject::whereIn('id', $idsArray)->delete();
