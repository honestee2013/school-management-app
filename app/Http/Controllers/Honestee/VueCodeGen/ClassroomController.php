...
class ClassroomController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($sortField)
            $classrooms = $query->orderBy($sortField, $sortType)->paginate( $perPage );
        else       
            $classrooms = $query->paginate( $perPage );
  
        return $this->sendResponse($classrooms, 'Classrooms list ');
    }
    ...
    public function search($request, $query)
    {
        ...
        $fields = Schema::getColumnListing('$classrooms');
    ...
    public function checkValidation(Request $request){
        $data = DB::select('DESCRIBE '.strtolower( 'Classrooms' ));
    ...
    public function update(Request $request, $id)
    {
        ...
        return $this->sendResponse($classroom, 'Classroom Information has been updated');
    }
    ...
    public function destroy($parameters)
    {
        ...
        if (array_key_exists('tbl', $data) && array_key_exists('pv_tbl', $data) 
           ...
           { // Many to Many relationships
            ...
            Classroom::whereIn('id', $idsArray)->delete();
