...
class SchoolController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request['id'] == "all"){
            ...
            $result = School::findOrFail($request['id']);
            return $this->sendResponse($result, 'Schools ');
        }
        ...
        if($sortField)
            $schools = $query->orderBy($sortField, $sortType)->paginate( $perPage );
        else       
            $schools = $query->paginate( $perPage );
  
        return $this->sendResponse($schools, 'Schools list ');
    }
    ...
    public function search($request, $query)
    {
        ...
        $fields = Schema::getColumnListing('$schools');
    ...
    public function checkValidation(Request $request){
        $data = DB::select('DESCRIBE '.strtolower( 'Schools' ));
