<template>
  <section class="content">
    ...
    <html-pdf :show-layout="false" :float-layout="true" :enable-download="true" :preview-modal="true"
      :paginate-elements-by-height="14000" filename="subject_lists" :pdf-quality="2" :manual-pagination="true"
            ...
            <vue-good-table mode="remote" @on-page-change="onPageChange" @on-sort-change="onSortChange"
                  ...
                  <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                      ...
                      <button href="#" class="dropdown-item">
                        ...
                        <json-excel class="" :data="subjects" :fields="table_heders" worksheet="Subject Lits"
                          name="subject_lists.xls">
                ...
                <span v-if="props.column.field == 'action'">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item " href="#" @click="deleteSubject(props.row.id)"><i class="fa fa-trash">
              ...
              <div slot="selected-row-actions">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item " href="#" @click="deleteSelectedSubjects()"><i class="fa fa-trash"> <span
    ...
    <!-- Detail Modal -->
    <div class="modal fade" id="subjectDetail" tabindex="-1" role="dialog" aria-labelledby="subjectDetail"
      aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-dismiss="modal" @click="deleteSubject(clickedRow.id)"><i
