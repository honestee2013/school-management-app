            ...
            <div class="form-row mb-2">
              ...
              <div class="col">
                <select class="custom-select" v-model="queryId" @change="onQueryIdChanged($event, 'user' )">
                  ...
                  <option v-if="users" v-for="row in users" :value="row.id+'_'+row.name" :selected="row.id == queryId">
                    {{ row.name }}</option>
                </select>
              </div>
            ...
            <vue-good-table v-show="queryId" mode="remote" @on-page-change="onPageChange" @on-sort-change="onSortChange"
              ...
              :totalRows="totalRecords" :isLoading.sync="isLoading" :select-options="{
                enabled: true,
                      ...
                      }" :rows="userClassrooms" :columns="columns">
                ...
                <span v-if="props.column.field == 'action'">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item " href="#" @click="deleteUserClassrooms(props.row.id)"><i
