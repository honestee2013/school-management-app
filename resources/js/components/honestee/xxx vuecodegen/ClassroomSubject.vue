              ...
              <div class="card w-100" v-if="$gate.isAdmin()" > 
                ...
                <div class="card-body table-responsive p-2"> 
                    <div class="form-row mb-2">
                        ...
                        <div class="col">
                            <select class="custom-select" v-model="queryId" @change="onQueryIdChanged($event, 'subject' )">
                              <option v-show = "(queryId==0)" selected value="0">Select subject</option>
                              <option v-if= "subjects" 
                            ...
                            <span v-if="props.column.field == 'action'">
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item " href="#" @click="deleteSubjectClassrooms(props.row.id)"><i class="fa fa-trash">  <span style="margin-left:0.1em"> Remove </span>  </i></a>
                                </div>
                              </div>
                            </span>
                            <span v-else>
        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form @submit.prevent="editmode ? updateSubjectClassrooms() : createSubjectClassrooms()">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        data-dismiss="modal" 
                        @click="deleteSubjectClassrooms(clickedRow.id)"><i class="fa fa-trash"></i> Remove </button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            updateSubjectClassrooms(){
                this.$Progress.start();
                // console.log('Editing data');
                this.form.put("api/classroom-subjects/"+this.form.id)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
                        ...
                        // Send request to the server
                         if (result.value) {
                              ...
                              parameters["pv_ids"] = id;//this.checkedClassrooms;
                                ...
                                //const theData = [id];
                                axios.delete('api/classroom-subjects/'+JSON.stringify(parameters) ).then(()=>{
                                        Swal.fire(
                                        'Deleted!',
                        ...
                        // Send request to the server
                         if (result.value) {
                              ...
                              parameters["pv_ids"] = this.selectedRows;//this.checkedClassrooms;
                                ...
                                axios.delete("api/classroom-subjects/"+theData).then(()=>{
                                        Swal.fire(
                                        'Deleted!',
                                        'The classroom was deleted successfully.',
                                        'success'
            ...
            createSubjectClassrooms(){
                ...
                var url = "api/classroom-subjects"+parameters;
                ...
                try{
                    this.form.get( url ).then( classrooms  => {
                        if(classrooms.data.data){
                          ...
                          this.subjectClassrooms = classrooms.data.data.data;
                          this.checkedClassrooms 
                            = this.subjectClassrooms
                            .map(function (data) { return data.id; });                        
