                  ...
                  <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                      ...
                      <button href="#" class="dropdown-item">
                        ...
                        <json-excel class="" :data="users" :fields="table_heders" worksheet="User Lits"
                          name="user_lists.xls">
                ...
                <span v-if="props.column.field == 'action'">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item " href="#" @click="deleteUser(props.row.id)"><i class="fa fa-trash"> <span
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="form.email" name="email" class="form-control"
                  :class="{ 'is-invalid': form.errors.has( 'email' ) }" maxlength="125">
                <has-error :form="form" field="email"></has-error>
              </div>
              <div class="form-group">
                <label>User number</label>
                <input type="text" v-model="form.user_number" name="user_number" class="form-control"
                  :class="{ 'is-invalid': form.errors.has( 'user_number' ) }" maxlength="125">
              </div>
              <div class="form-group">
                <label>Parent number</label>
                <input type="number" v-model="form.parent_number" class="form-control"
                  :class="{ 'is-invalid': form.errors.has( 'parent_number' ) }"></input>
              </div>
              <div class="form-group">
                <label>Password</label>
                <input type="password" v-model="form.password" name="password" class="form-control"
                  :class="{ 'is-invalid': form.errors.has( 'password' ) }" maxlength="125">
              ...
              <div class="form-group">
                ...
                <input type="number" v-model="form.email_verified_at" class="form-control"
                  :class="{ 'is-invalid': form.errors.has( 'email_verified_at' ) }"></input>
              </div>
              <div class="form-group">
                <label>Remember token</label>
                <input type="text" v-model="form.remember_token" name="remember_token" class="form-control"
                  :class="{ 'is-invalid': form.errors.has( 'remember_token' ) }" maxlength="100">
              </div>
              <div class="form-group">
    ...
    <div class="modal fade" id="userDetail" tabindex="-1" role="dialog" aria-labelledby="userDetail" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-dismiss="modal" @click="deleteUser(clickedRow.id)"><i
