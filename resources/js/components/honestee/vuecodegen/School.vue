<template>
  <section class="content">
    ...
    <html-pdf :show-layout="false" :float-layout="true" :enable-download="true" :preview-modal="true"
      :paginate-elements-by-height="14000" filename="school_lists" :pdf-quality="2" :manual-pagination="true"
  ...
  placeholder: 'Search the table',
                  ...
                  <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                      ...
                      <button href="#" class="dropdown-item">
                        ...
                        <json-excel class="" :data="schools" :fields="table_heders" worksheet="School Lits"
                          name="school_lists.xls">
                ...
                <span v-if="props.column.field == 'action'">
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                      ...
                      <a class="dropdown-item " href="#" @click="deleteSchool(props.row.id)"><i class="fa fa-trash">
              ...
              <div slot="selected-row-actions">
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item " href="#" @click="deleteSelectedSchools()"><i class="fa fa-trash"> <span
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <textarea v-model="form.address" :class="{ 'is-invalid': form.errors.has('address') }"
                  class="form-control" style="min-height: 100px; max-height: 300px;"></textarea>
                <has-error :form="form" field="address"></has-error>
              </div>
              <div class="form-group">
                <label>Phone no 1</label>
                <input type="text" v-model="form.phone_no_1" name="phone_no_1" class="form-control"
                  :class="{ 'is-invalid': form.errors.has('phone_no_1') }" maxlength="125">
                <has-error :form="form" field="phone_no_1"></has-error>
              </div>
              <div class="form-group">
                <label>Phone no 2</label>
                <input type="text" v-model="form.phone_no_2" name="phone_no_2" class="form-control"
                  :class="{ 'is-invalid': form.errors.has('phone_no_2') }" maxlength="125">
                <has-error :form="form" field="phone_no_2"></has-error>
              </div>
              <div class="form-group">
                <label>Email 1</label>
                <input type="text" v-model="form.email_1" name="email_1" class="form-control"
                  :class="{ 'is-invalid': form.errors.has('email_1') }" maxlength="125">
                <has-error :form="form" field="email_1"></has-error>
              </div>
              <div class="form-group">
                <label>Email 2</label>
                <input type="text" v-model="form.email_2" name="email_2" class="form-control"
                  :class="{ 'is-invalid': form.errors.has('email_2') }" maxlength="125">
                <has-error :form="form" field="email_2"></has-error>
              </div>
              
              <label for="schoolBatch">School batch</label>     
              <div class="form-group">
                <input type="file" class="custom-file-inpu" id="schoolBatch" 
                  ref="file" @change="handleFileObject"
                  accept="image/*"
                >
                <has-error :form="form" field="schoolBatch"></has-error>
              </div>

              <label for="schoolStamp">School stamp</label>     
              <div class="form-group">
                <input type="file" class="custom-file-inpu" id="schoolStamp" 
                  :class="{ 'is-invalid': form.errors.has('schoolStamp') }"
                  ref="file" @change="handleFileObject"
                  accept="image/*"
                >
                <has-error :form="form" field="schoolStamp"></has-error>
              </div>
    ...
    <!-- Detail Modal -->
    <div class="modal fade" id="schoolDetail" tabindex="-1" role="dialog" aria-labelledby="schoolDetail"
      aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-dismiss="modal" @click="deleteSchool(clickedRow.id)"><i
...
export default {
  data() {
    return {
      ...
      schoolBatchObj: '',
      schoolBatchName: 'choose...',
      schoolStampObj: '',
      schoolStampName: 'choose...',
  ...
  methods: {
    ...
    handleFileObject(e) {
       if(e.target.id == 'schoolStamp'){
          this.schoolStampObj = e.target.files[0];
          //this.schoolStampName = this.schoolStamp.name;
        } else {
          this.schoolBatchObj = e.target.files[0];
          //this.schoolBatchName = this.schoolBatchObj.name;
        }
