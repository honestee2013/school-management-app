                  ...
                  <table class="table table-bordered" style="width: 100%; ">
                        ...
                        <tbody >
                            <tr v-for="(assessment, index) in assessments" :key="assessment.id">
                                                                                                                                                                              <td>{{ assessment.section_id }} </td>
                                                                                                                                              <td>{{ assessment.classroom_id }} </td>
                  ...
                  <form @submit.prevent="editmode ? updateAssessment() : createAssessment()">
                    <div class="modal-body">
                                  ...
                                  <select v-model="form.classroom_id" name="classroom_id" class="form-control" 
                                      ...
                                      <option v-for="(item, index)  in classrooms"
                                            :key= "index" :value="item.id"> {{item.name}} </option>
                                  </select>
                                  ...
                                  <select v-model="form.subject_id" name="subject_id" class="form-control" 
                                      ...
                                      <option v-for="(item, index)  in subjects"
                                            :key= "index" :value="item.id"> {{item.name}} </option>
                                  </select>
